...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["food-food-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFoodAddFoodAddFoodComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFoodAllFoodsAllFoodsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFoodFoodComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFoodViewFoodViewFoodComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFoodAddFoodAddFoodComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_shared_service_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _shared_service_food_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./../../../shared/service/food.service */
    ...
    var AddFoodComponent = /*#__PURE__*/function () {
      function AddFoodComponent(fb, foodService, authService, messageSerive, router, activatedRoute) {
      ...
      _createClass(AddFoodComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.paramMap.subscribe(function (params) {
            ...
            if (id) {
              _this.selectedFood = _this.foodService.getFood(id);

              if (_this.selectedFood) {
                _this.setCurrentValue();
              } else {
                _this.messageSerive.error('No food found!');

                _this.router.navigate(['food/all-foods']);
              }
            }
          });
        }
        ...
        value: function submitForm(formValue) {
          ...
          if (this.foodForm.valid) {
            ...
            if (this.selectedFood) {
              ...
              var status = this.foodService.editFood(formValue);
              ...
              var _status = this.foodService.addFood(formValue);
    ...
    AddFoodComponent.ctorParameters = function () {
      return [{
    ...
    AddFoodComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
      selector: 'app-add-food',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./add-food.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/food/add-food/add-food.component.html"))["default"]
    })], AddFoodComponent);
    /***/
  },
  ...
  /***/
  function srcAppFoodAllFoodsAllFoodsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AllFoodsComponent", function () {
    ...
    var _shared_service_food_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../shared/service/food.service */
    "./src/shared/service/food.service.ts");
    /* harmony import */
    ...
    var AllFoodsComponent = /*#__PURE__*/function () {
      function AllFoodsComponent(foodService, messageService) {
        _classCallCheck(this, AllFoodsComponent);

        this.foodService = foodService;
        this.messageService = messageService;
      }

      _createClass(AllFoodsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        value: function deleteConfirm(id) {
          var status = this.foodService.deleteFood(id);

          if (status) {
            this.messageService.success('Successfully deleted!');
            this.foodList = this.foodList.filter(function (x) {
              return x.id !== id;
            });
          } else {
    ...
    AllFoodsComponent.ctorParameters = function () {
      return [{
    ...
    AllFoodsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      selector: 'app-all-foods',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./all-foods.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/food/all-foods/all-foods.component.html"))["default"]
    })], AllFoodsComponent);
    /***/
  },
  ...
  /***/
  function srcAppFoodFoodRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FoodRoutingModule", function () {
    ...
    var _view_food_view_food_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./view-food/view-food.component */
    "./src/app/food/view-food/view-food.component.ts");
    /* harmony import */


    var _food_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./food.component */
    ...
    var _add_food_add_food_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./add-food/add-food.component */
    "./src/app/food/add-food/add-food.component.ts");
    /* harmony import */


    var _all_foods_all_foods_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./all-foods/all-foods.component */
    "./src/app/food/all-foods/all-foods.component.ts");
    /* harmony import */
    ...
    var FoodRoutingModule = function FoodRoutingModule() {
      _classCallCheck(this, FoodRoutingModule);
    };

    FoodRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_7__["NgModule"])({
  ...
  /***/
  function srcAppFoodFoodComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var FoodComponent = /*#__PURE__*/function () {
      function FoodComponent(authService) {
    ...
    FoodComponent.ctorParameters = function () {
      return [{
        type: _shared_service_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]
      }];
    };

    FoodComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: 'app-food',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./food.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/food/food.component.html"))["default"]
    })], FoodComponent);
    /***/
  },
  ...
  /***/
  function srcAppFoodFoodModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FoodModule", function () {
      return FoodModule;
    });
    /* harmony import */
    ...
    var _shared_guard_auth_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./../../shared/guard/auth.guard */
    "./src/shared/guard/auth.guard.ts");
    /* harmony import */
    ...
    var _food_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./food-routing.module */
    "./src/app/food/food-routing.module.ts");
    /* harmony import */
    ...
    var _all_foods_all_foods_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./all-foods/all-foods.component */
    "./src/app/food/all-foods/all-foods.component.ts");
    /* harmony import */


    var _add_food_add_food_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./add-food/add-food.component */
    "./src/app/food/add-food/add-food.component.ts");
    /* harmony import */


    var _food_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./food.component */
    "./src/app/food/food.component.ts");
    /* harmony import */


    var _view_food_view_food_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./view-food/view-food.component */
    "./src/app/food/view-food/view-food.component.ts");

    var FoodModule = function FoodModule() {
      _classCallCheck(this, FoodModule);
    };

    FoodModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_all_foods_all_foods_component__WEBPACK_IMPORTED_MODULE_8__["AllFoodsComponent"], _add_food_add_food_component__WEBPACK_IMPORTED_MODULE_9__["AddFoodComponent"], _food_component__WEBPACK_IMPORTED_MODULE_10__["FoodComponent"], _view_food_view_food_component__WEBPACK_IMPORTED_MODULE_11__["ViewFoodComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"], _food_routing_module__WEBPACK_IMPORTED_MODULE_6__["FoodRoutingModule"], ng_zorro_antd_card__WEBPACK_IMPORTED_MODULE_3__["NzCardModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzFormModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzButtonModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzGridModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzSpinModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzLayoutModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzMenuModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzAvatarModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzPopoverModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzListModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzSelectModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzMessageModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzUploadModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzTableModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzIconModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzTagModule"], ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__["NzPopconfirmModule"]],
  ...
  /***/
  function srcAppFoodViewFoodViewFoodComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewFoodComponent", function () {
    ...
    var ViewFoodComponent = /*#__PURE__*/function () {
      function ViewFoodComponent(foodService, activatedRoute, router, messageService) {
        _classCallCheck(this, ViewFoodComponent);
      ...
      _createClass(ViewFoodComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this2 = this;

          this.activatedRoute.paramMap.subscribe(function (params) {
            var foodId = params.get('id');

            if (foodId) {
              _this2.selectedFood = _this2.foodService.getFood(foodId);

              if (!_this2.selectedFood) {
                _this2.messageService.error('No food found!');

                _this2.router.navigate(['food/all-foods']);
              }
            }
          });
        }
    ...
    ViewFoodComponent.ctorParameters = function () {
      return [{
        type: _shared_service_food_service__WEBPACK_IMPORTED_MODULE_2__["FoodService"]
      }, {
    ...
    ViewFoodComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      selector: 'app-view-food',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./view-food.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/food/view-food/view-food.component.html"))["default"]
    })], ViewFoodComponent);
    /***/
  },
  ...
  /***/
  function srcSharedGuardAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcSharedServiceFoodServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var FoodService = /*#__PURE__*/function () {
      function FoodService(authService) {
      ...
      _createClass(FoodService, [{
        ...
        value: function getFood(id) {
          return this.foodList.find(function (x) {
            return x.id === id;
          });
        }
      }, {
        ...
        key: "editFood",
        value: function editFood(model) {
          var index = this.foodList.findIndex(function (x) {
    ...
    FoodService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    })], FoodService);
    /***/
  }
}]);
//# sourceMappingURL=food-food-module-es5.js.map